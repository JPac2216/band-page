...
export default function Home() {
  return (
    ...
    >
      <div className="relative min-h-screen flex flex-col items-center justify-start pt-16 gap-4 z-10">
        <motion.div
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-start pt-0 gap-4 z-10">
