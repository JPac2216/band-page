        ...
        >
            <div className="relative flex flex-col items-center justify-start pt-16 z-10 gap-24">
                ...
                <h1 className="text-4xl font-semibold text-center tracking-tight text-white leading-tight ">
                    Find all upcoming shows on our Instagram!
                </h1>
                <h1 className="text-4xl font-semibold text-center tracking-tight text-white leading-tight ">
                    Follow us for updates: <a className="text-yellow-400 italic underline" href="https://www.instagram.com/direct/t/17846797725172316/">@midnightdrive_nj</a>
                </h1>
            </div>
        </div>
    );
